...
from suporte_console.diagnostico_conjuntos.patch_participantes_compartilhados import PatchParticipantesCompartilhados


class PatchClientesFornecedoresCompartilhados(PatchParticipantesCompartilhados):
    """
    Patch para resolver o problema de quando clientes ou fornecedores
    estejam indevidamente compartilhado por mais de um conjunto.
    """
