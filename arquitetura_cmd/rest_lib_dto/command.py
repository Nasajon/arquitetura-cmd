...
class RestLibDTOCommand(Command):
    ...
    def main(self, pars: List[str]):
        ...
        try:
            ...
            URL_EXEMPLOS = "https://raw.githubusercontent.com/Nasajon/arquitetura-cmd/refs/heads/main/arquitetura_cmd/rest_lib_dto/exemplos_para_chatgpt.txt"
            ...
            pergunta = f"""
Gere um DTO para a tabela abaixo:
